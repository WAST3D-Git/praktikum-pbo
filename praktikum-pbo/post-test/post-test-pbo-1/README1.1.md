...
Program ini adalah simulasi sistem manajemen pesanan sederhana berbasis Object-Oriented Programming menggunakan Python. Program ini dirancang untuk mencatat data klien, mendaftar layanan yang ditawarkan oleh studio, serta memproses pesanan hingga mencetak invoice tagihan. 
...
- Method Utama:
  ...
  - @classmethod dari_string(cls, data_string): Sebuah alternative constructor untuk membuat objek Layanan dari format string teks yang dipisahkan tanda strip.
...
- Method Utama:
  ...
  - @classmethod ubah_pajak_studio(cls, pajak_baru): Mengubah persentase pajak untuk seluruh transaksi di   
    dalam studio.
...
4. Navigasikan ke direktori tempat file disimpan, lalu jalankan perintah: python main.py
